...
class MqThread:
    ...
    def __init__(self, event_stop: Event, etat_ceduleur, command_handler: CommandHandler, routing_keys_consumers: list):
        self.__logger = logging.getLogger(__name__ + '.' + self.__class__.__name__)
        self.__event_stop = event_stop
        self.__etat_instance = etat_ceduleur
...
class RabbitMQDao:
    ...
    async def creer_thread(self):
        ...
        #     routing_keys.append('evenement.GrosFichiers.annulerJobVideo')

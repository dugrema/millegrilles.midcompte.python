...
class ConfigurationCeduleur:

    def __init__(self):
        self.ca_pem_path = '/var/opt/millegrilles/configuration/pki.millegrille.cert'
        self.cert_pem_path = '/var/opt/millegrilles/secrets/pki.ceduleur.cert'
        self.key_pem_path = '/var/opt/millegrilles/secrets/pki.ceduleur.cle'

...
class ConfigurationRelaiWeb:

    def __init__(self):
        self.ca_pem_path = '/var/opt/millegrilles/configuration/pki.millegrille.cert'
        self.cert_pem_path = '/var/opt/millegrilles/secrets/pki.relai_web.cert'
        self.key_pem_path = '/var/opt/millegrilles/secrets/pki.relai_web.cle'
    ...
    def get_env(self) -> dict:
        ...
        """
        config = dict()
        for opt_param in CONST_RELAIWEB_PARAMS:
